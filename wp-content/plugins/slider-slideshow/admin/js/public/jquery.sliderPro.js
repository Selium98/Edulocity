...
;(function( window, $ ) {
	...
	SliderPro.prototype = {
		...
		resetAnimationsToDefault: function() {
				...
				this.settings.fade = false;
                this.settings.customrotate = false;
                this.settings.customantirotate = false;
                this.settings.customcube = false;
                this.settings.customcubeCount = 1;
                this.settings.customcubeori = 'h';
                this.settings.customzoom = false;
                this.settings.customzoomout = false;
                this.settings.customslice = false;
                this.settings.customsliceEffect = 'wave';
		},

		saveAnimationsToOld: function() {
				
				
				this.settings.oldfade = this.settings.fade;
                this.settings.oldcustomrotate = this.settings.customrotate;
                this.settings.oldcustomantirotate = this.settings.customantirotate;
                this.settings.oldcustomcube = this.settings.customcube;
                this.settings.oldcustomcubeCount = this.settings.customcubeCount;
                this.settings.oldcustomcubeori = this.settings.customcubeori;
                this.settings.oldcustomzoom = this.settings.customzoom;
                this.settings.oldcustomzoomout = this.settings.customzoomout;
                this.settings.oldcustomslice = this.settings.customslice;
                this.settings.oldcustomsliceEffect = this.settings.customsliceEffect;

		},

		restoreAnimationsToOld: function() {
			
				this.settings.fade = this.settings.oldfade;
                this.settings.customrotate = this.settings.oldcustomrotate;
                this.settings.customantirotate = this.settings.oldcustomantirotate;
                this.settings.customcube = this.settings.oldcustomcube;
                this.settings.customcubeCount = this.settings.oldcustomcubeCount;
                this.settings.customcubeori = this.settings.oldcustomcubeori;
                this.settings.customzoom = this.settings.oldcustomzoom;
                this.settings.customzoomout = this.settings.oldcustomzoomout;
                this.settings.customslice = this.settings.oldcustomslice;
                this.settings.customsliceEffect = this.settings.oldcustomsliceEffect;

		},

		doCustomSlideAnimation: function( index ) {
			var that = this;


            var custom_slide_animation = that.$slider.find('.sp-slide').eq( index  ).data('animation');
			
			this.resetAnimationsToDefault();
			
			if ( custom_slide_animation == 'fade' ) {
			...
			} else if ( custom_slide_animation == 'slide' ) {

				this.gotoSlide = this.originalGotoSlide;
			
			} else if ( custom_slide_animation == 'sliceslide' ) {

				this.settings.customslice = true;
                this.settings.customsliceEffect = 'slide';

                this.customsliceGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customsliceGotoSlide;

			} else if ( custom_slide_animation == 'rotate' ) {

				this.settings.customrotate = true;

				this.customrotateGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customrotateGotoSlide;

			} else if ( custom_slide_animation == 'antirotate' ){

				this.settings.customantirotate = true;

				this.customantirotateGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customantirotateGotoSlide;

			} else if ( custom_slide_animation == 'cube' ){

				this.settings.customcube = true;

				this.customcubeGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customcubeGotoSlide;

			} else if ( custom_slide_animation == 'cubey' ) {

				this.settings.customcubeori = 'v';
				this.settings.customcube = true;

				this.customcubeGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customcubeGotoSlide;

			} else if ( custom_slide_animation == 'zoom' ) {

				this.settings.customzoomout = false;
				this.settings.customzoom = true;

				this.customzoomGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customzoomGotoSlide;

			} else if ( custom_slide_animation == 'zoomout' ) {

				this.settings.customzoomout = true;
				this.settings.customzoom = true;

				this.customzoomGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customzoomGotoSlide;

			} else if ( custom_slide_animation == 'cube3x' ) {

				this.settings.customcube = true;
				this.settings.customcubeori = 'h';
				this.settings.customcubeCount = 3;

				this.customcubeGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customcubeGotoSlide;

			} else if ( custom_slide_animation == 'cube3y' ) {
			...
			} else if ( custom_slide_animation == 'cube5x' ) {

				this.settings.customcube = true;
				this.settings.customcubeori = 'h';
				this.settings.customcubeCount = 5;

				this.customcubeGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customcubeGotoSlide;

			} else if ( custom_slide_animation == 'cube5y' ) {
			...
			} else if ( custom_slide_animation == "slicewave" ) {
            ...
            else if ( custom_slide_animation == "slice" ) {

                this.settings.customslice = true;
                this.settings.customsliceEffect = 'slice';

                this.customsliceGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customsliceGotoSlide;
            }

            else if ( custom_slide_animation == "puzzle" ) {
                  this.settings.customslice = true;
                  this.settings.customsliceEffect = 'puzzle';
            }

            else if ( custom_slide_animation == "assemble" ) {
                
                this.settings.customslice = true;
                this.settings.customsliceEffect = 'assemble';

                this.customsliceGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customsliceGotoSlide;
            }

            else if ( custom_slide_animation == "ripple" ) {
                  
                this.settings.customslice = true;
                this.settings.customsliceEffect = 'ripple';
		...
		nextSlide: function() {
			...
			this.doCustomSlideAnimation(index);
	...
	var Layers = {
		...
		_layersOnUpdate: function( event ) {
			...
			$.each( this.slides, function( index, element ) {
				...
				this.$slide.find( '.sp-layer' ).each(function() {
	...
	Layer.prototype = {
		...
		show: function( callback ) {
			...
			var that = this,
				...
				delay = typeof this.data.delay !== 'undefined' ? this.data.delay : 10,

				stayDuration = typeof that.data.stayDuration !== 'undefined' ? parseInt( that.data.stayDuration, 10 ) : -1;
				
				if ( that.data.ishide === 1 ) {

					stayDuration = parseInt( that.data.hideafter );
			...
			if ( true ) {
				...
				var that = this
				that.layerTimeout = setTimeout(function(){
					that.$layer.removeClass( that.data.hidewith );
					that.$layer
					.addClass('animated').addClass(that.data.animation).css({  'visibility': 'visible', 'opacity': '1' });
				}, delay);
				

				this.$layer.on(this.vendorPrefix+'animationend', function() {
						//that.$layer.removeClass( 'animated' );
						that.$layer.removeClass( that.data.animation );
						
						// Hide the layer after a given time interval
						if ( stayDuration !== -1 ) {
							that.stayTimer = setTimeout(function() {
								//that.hide();
								that.$layer.addClass(that.data.hidewith);
								that.stayTimer = null;
							}, stayDuration );
						}
		...
		hide: function( callback ) {
			...
			if ( this.layerTimeout !== null ) {
				clearTimeout(that.layerTimeout);
			}
			...
			if ( true ) {
				this.$layer
					...
					.animate({ 'opacity': 0 }, duration * 1000, function() {
						...
						if ( $( this ).hasClass(that.data.animation) )
							$( this ).removeClass(that.data.animation);

						if ( $( this ).hasClass(that.data.hidewith) )
							$( this ).removeClass(that.data.hidewith);
...
// CustomRotate module for Slider Pro.
// 
// Adds the possibility to navigate through slides using a customrotate effect.
;(function( window, $ ) {

	"use strict";

	var NS = 'CustomRotate.' + $.SliderPro.namespace;

	var CustomRotate = {

		// Reference to the original 'gotoSlide' method
		customrotateGotoSlideReference: null,

		initCustomRotate: function() {
			this.on( 'update.' + NS, $.proxy( this._customrotateOnUpdate, this ) );
		},

		// If customrotate is enabled, store a reference to the original 'gotoSlide' method
		// and then assign a new function to 'gotoSlide'.
		_customrotateOnUpdate: function() {
			if ( this.settings.customrotate === true ) {
				this.customrotateGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customrotateGotoSlide;
			}
		},

		// Will replace the original 'gotoSlide' function by adding a cross-customrotate effect
		// between the previous and the next slide.
		_customrotateGotoSlide: function( index ) {
			if ( index === this.selectedSlideIndex ) {
				return;
			}
			...
			// If the slides are being swiped/dragged, don't use customrotate, but call the original method instead.
			// If not, which means that a new slide was selected through a button, arrows or direct call, then
			// use customrotate.
			if ( this.$slider.hasClass( 'sp-swiping' ) ) {
				this.customrotateGotoSlideReference( index );
			} else {
				var that = this,
					$nextSlide,
					$previousSlide,
				...
				// CustomRotate out the previous slide, if indicated, in addition to fading in the next slide
				if ( this.settings.customrotateOutPreviousSlide === true ) {
					this._customrotateSlideTo( $previousSlide, 0 );
				}

				// CustomRotate in the selected slide
				this._customrotateSlideTo( $nextSlide, 1, function() {
		...
		// CustomRotate the target slide to the specified opacity (0 or 1)
		_customrotateSlideTo: function( target, opacity, callback ) {
			var that = this;

			var duration = 1000;

			if ( target.data('slideduration') !== '' )
				duration = parseInt( target.data('slideduration') );
			...
			if ( this.supportedAnimation === 'css-3d' || this.supportedAnimation === 'css-2d' ) {
				...
				target.on( 'webkitAnimationEnd oanimationend msAnimationEnd animationend', function( event ) {
					if ( event.target !== event.currentTarget ) {
						return;
					}
					
					target.off( 'webkitAnimationEnd oanimationend msAnimationEnd animationend' );
				...
				target.stop().animate({ 'opacity': opacity }, duration, function() {
					if ( typeof callback === 'function' ) {
						callback();
					}
					this.isAnimating = false;
		...
		// Destroy the module
		destroyCustomRotate: function() {
			this.off( 'update.' + NS );

			if ( this.customrotateGotoSlideReference !== null ) {
				this.gotoSlide = this.customrotateGotoSlideReference;
			}
		},

		customrotateDefaults: {

			// Indicates if customrotate will be used
			customrotate: false,

			// Indicates if the previous slide will be customrotated out (in addition to the next slide being customrotated in)
			customrotateOutPreviousSlide: true,

			// Sets the duration of the customrotate effect
			customrotateDuration: 500
		}
	};

	$.SliderPro.addModule( 'CustomRotate', CustomRotate );

})( window, jQuery );

// CustomAntiRotate module for Slider Pro.
// 
// Adds the possibility to navigate through slides using a customantirotate effect.
;(function( window, $ ) {

	"use strict";

	var NS = 'CustomAntiRotate.' + $.SliderPro.namespace;

	var CustomAntiRotate = {

		// Reference to the original 'gotoSlide' method
		customantirotateGotoSlideReference: null,

		initCustomAntiRotate: function() {
			this.on( 'update.' + NS, $.proxy( this._customantirotateOnUpdate, this ) );
		},

		// If customantirotate is enabled, store a reference to the original 'gotoSlide' method
		// and then assign a new function to 'gotoSlide'.
		_customantirotateOnUpdate: function() {
			if ( this.settings.customantirotate === true ) {
				this.customantirotateGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customantirotateGotoSlide;
			}
		},

		// Will replace the original 'gotoSlide' function by adding a cross-customantirotate effect
		// between the previous and the next slide.
		_customantirotateGotoSlide: function( index ) {
			if ( index === this.selectedSlideIndex ) {
				return;
			}
			...
			// If the slides are being swiped/dragged, don't use customantirotate, but call the original method instead.
			// If not, which means that a new slide was selected through a button, arrows or direct call, then
			// use customantirotate.
			if ( this.$slider.hasClass( 'sp-swiping' ) ) {
				this.customantirotateGotoSlideReference( index );
			} else {
				var that = this,
					$nextSlide,
					$previousSlide,
				...
				// CustomAntiRotate out the previous slide, if indicated, in addition to fading in the next slide
				if ( this.settings.customantirotateOutPreviousSlide === true ) {
					this._customantirotateSlideTo( $previousSlide, 0 );
				}

				// CustomAntiRotate in the selected slide
				this._customantirotateSlideTo( $nextSlide, 1, function() {
		...
		// CustomAntiRotate the target slide to the specified opacity (0 or 1)
		_customantirotateSlideTo: function( target, opacity, callback ) {
			var that = this;
			...
			if ( this.supportedAnimation === 'css-3d' || this.supportedAnimation === 'css-2d' ) {
				...
				setTimeout(function(){
					...
					target.css({
				        ...
				        //for firefox
				        "-moz-animation-name":"wprlsantirotatebox",
				        "-moz-animation-duration":(duration/1000)+"s",
				        "-moz-animation-iteration-count":"1",
				            "-moz-animation-fill-mode":"forwards",

				        //for safari & chrome
				        "-webkit-animation-name":"wprlsantirotatebox",
				        "-webkit-animation-duration":(duration/1000)+"s",
				        "-webkit-animation-iteration-count":"1",
				        "-webkit-animation-fill-mode" : "forwards",

				        //standard
				        "animation-name":"wprlsantirotatebox",
				        "animation-duration":(duration/1000)+"s",
				        "animation-iteration-count":"1",
				        "animation-fill-mode" : "forwards",
		...
		// Destroy the module
		destroyCustomAntiRotate: function() {
			this.off( 'update.' + NS );

			if ( this.customantirotateGotoSlideReference !== null ) {
				this.gotoSlide = this.customantirotateGotoSlideReference;
			}
		},

		customantirotateDefaults: {

			// Indicates if customantirotate will be used
			customantirotate: false,

			// Indicates if the previous slide will be customantirotated out (in addition to the next slide being customantirotated in)
			customantirotateOutPreviousSlide: true,

			// Sets the duration of the customantirotate effect
			customantirotateDuration: 500
		}
	};

	$.SliderPro.addModule( 'CustomAntiRotate', CustomAntiRotate );

})( window, jQuery );

// CustomSlice module for Slider Pro.
// 
// Adds the possibility to navigate through slides using a customslice effect.
;(function( window, $ ) {

	"use strict";

	var NS = 'CustomSlice.' + $.SliderPro.namespace;

	var CustomSlice = {

		// Reference to the original 'gotoSlide' method
		customsliceGotoSlideReference: null,

		initCustomSlice: function() {
			this.on( 'update.' + NS, $.proxy( this._customsliceOnUpdate, this ) );
		},

		// If customslice is enabled, store a reference to the original 'gotoSlide' method
		// and then assign a new function to 'gotoSlide'.
		_customsliceOnUpdate: function() {
			if ( this.settings.customslice === true ) {
				this.customsliceGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customsliceGotoSlide;
			}
		},

		// Will replace the original 'gotoSlide' function by adding a customslice effect
		// between the previous and the next slide.
		_customsliceGotoSlide: function( index ) {
			if ( index === this.selectedSlideIndex ) {
				return;
			}
			that = this;
			...
			// If the slides are being swiped/dragged, don't use customslice, but call the original method instead.
			// If not, which means that a new slide was selected through a button, arrows or direct call, then
			// use customslice.
			if ( this.$slider.hasClass( 'sp-swiping' ) ) {

				this.originalGotoSlide( index );

			} else {

				if ( that.settings.isAnimating ) {
					return;
				}
				...
				// Set the new indexes for the previous and selected slides
				that.previousSlideIndex = that.selectedSlideIndex;
				that.selectedSlideIndex = index;

				// Re-assign the 'sp-selected' class to the currently selected slide
				that.$slides.find( '.sp-selected' ).removeClass( 'sp-selected' );
				that.$slides.find( '.sp-slide' ).eq( that.selectedSlideIndex ).addClass( 'sp-selected' );
				...
				// Move the slides container so that the cross-fading slides (which now have the top and left
				// position set to 0) become visible and in the center of the slider.
				that._moveTo( that.visibleOffset, true );

				// CustomSlice out the previous slide, if indicated, in addition to fading in the next slide
				if ( that.settings.customsliceOutPreviousSlide === true ) {
					that._customsliceSlideTo( $previousSlide, 0 );
				}

				var $container = $previousSlide.find( '.sp-image-container' ).find('img');
				var $container_next = $nextSlide.find( '.sp-image-container' ).find('img');

				var customEffect = this.settings.customsliceEffect;
				
				var duration = 1000;

				if ( $nextSlide.data('slideduration') !== '' )
					duration = parseInt( $nextSlide.data('slideduration') );

				var fillmode = 'forwards';

				var tiles_effect = 'slideFromLeft';

				that.settings.isAnimating = true;
				
				
				if ( this.slideDirection == 'prev'  ) {
					fillmode = 'backwards';
					tiles_effect = 'slideFromRight'; 
				}

				if ( customEffect == 'slide' ) {

					$container_next.stop().animate( tiles_effect, {
						"duration": duration,
						 
						start: function( options ) {
							
								$nextSlide.css({
								'-moz--name': 'wprlscubebox',
								'-moz--duration': (duration/1000)+'s',
								'-moz--iteration-count': '1',
								'-moz--fill-mode': 'forwards',
								'-moz--timing': 'ease',

								'-webkit-name': 'wprlscubebox',
								'-webkit-duration': (duration/1000)+'s',
								'-webkit-iteration-count': '1',
								'-webkit-fill-mode': 'forwards',
								'-webkit-timing': 'ease',

								'animation-name': 'wprlscubebox',
								'animation-duration': (duration/1000)+'s',
								'animation-iteration-count': '1',
								'animation-fill-mode': 'forwards',
								...
								$nextSlide.on( 'webkitAnimationEnd oanimationend msAnimationEnd animationend', function( event ) {
										if ( event.target !== event.currentTarget ) {
											return;
										}
										
									$nextSlide.off( 'webkitAnimationEnd oanimationend msAnimationEnd animationend' );
 						...
 						complete: function( options ) {
							...
							that.settings.isAnimating = false;
				...
				if ( customEffect == 'slice' ) {
					$container_next.stop().animate( 'tile', {
						"duration": duration,
						  "cols": 10,
						  'sequent': false,
						  "effect": tiles_effect,
				...
				if ( customEffect == 'wave' ) {

					//$previousSlide.css({ 'opacity': 1, 'left': 0, 'top': 0, 'z-index': 20 });

					//$nextSlide.css({ 'opacity': 0, 'left': 0, 'top': 0, 'z-index': 10 });

					//console.log( 'Current Index: '+ $container_next.attr('src') );
					//console.log( 'Previous Index: '+  $container.attr('src') );
				...
				// Fire the 'gotoSlide' event
				that.trigger({ type: 'gotoSlide', index: index, previousIndex: that.previousSlideIndex });
				if ( $.isFunction( that.settings.gotoSlide ) ) {
					that.settings.gotoSlide.call( that, { type: 'gotoSlide', index: index, previousIndex: that.previousSlideIndex });
				}
				
			}
		},

		// CustomSlice the target slide to the specified opacity (0 or 1)
		_customsliceSlideTo: function( target, opacity, callback ) {
			var that = this;
			...
			if ( this.supportedAnimation === 'css-3d' || this.supportedAnimation === 'css-2d' ) {
				...
				target.stop().animate({ 'opacity': opacity }, this.settings.customsliceDuration, function() {
					if ( typeof callback === 'function' ) {
						callback();
					}
				});
		...
		// Destroy the module
		destroyCustomSlice: function() {
			this.off( 'update.' + NS );

			if ( this.customsliceGotoSlideReference !== null ) {
				this.gotoSlide = this.customsliceGotoSlideReference;
			}
		},

		customsliceDefaults: {

			// Indicates if customslice will be used
			customslice: false,

			// Indicates if the previous slide will be customsliced out (in addition to the next slide being customsliced in)
			customsliceOutPreviousSlide: false,

			// Sets the duration of the customslice effect
			customsliceDuration: 700,

			customsliceEffect: 'wave'
		}
	};

	$.SliderPro.addModule( 'CustomSlice', CustomSlice );
...
// CustomCube module for Slider Pro.
// 
// Adds the possibility to navigate through slides using a customcube effect.
;(function( window, $ ) {

	"use strict";

	var NS = 'CustomCube.' + $.SliderPro.namespace;

	var CustomCube = {

		// Reference to the original 'gotoSlide' method
		customcubeGotoSlideReference: null,

		initCustomCube: function() {
			this.on( 'update.' + NS, $.proxy( this._customcubeOnUpdate, this ) );
		},

		// If customcube is enabled, store a reference to the original 'gotoSlide' method
		// and then assign a new function to 'gotoSlide'.
		_customcubeOnUpdate: function() {
			if ( this.settings.customcube === true ) {
				this.customcubeGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customcubeGotoSlide;
			}
		},

		// Will replace the original 'gotoSlide' function by adding a cross-customcube effect
		// between the previous and the next slide.
		_customcubeGotoSlide: function( index ) {
			if ( index === this.selectedSlideIndex ) {
				return;
			}
			...
			// If the slides are being swiped/dragged, don't use customcube, but call the original method instead.
			// If not, which means that a new slide was selected through a button, arrows or direct call, then
			// use customcube.
			if ( this.$slider.hasClass( 'sp-swiping' ) ) {
				this.customcubeGotoSlideReference( index );
			} else {
				var that = this,
					$nextSlide,
					$previousSlide,
				...
				// CustomCube out the previous slide, if indicated, in addition to fading in the next slide
				if ( this.settings.customcubeOutPreviousSlide === true ) {
					this._customcubeSlideTo( $previousSlide, 0 );
				}

				// CustomCube in the selected slide
				this._customcubeSlideTo( $nextSlide, 1, function() {
		...
		// CustomCube the target slide to the specified opacity (0 or 1)
		_customcubeSlideTo: function( target, opacity, callback ) {
			var that = this;

			// Use CSS transitions if they are supported. If not, use JavaScript animation.
			if ( this.supportedAnimation === 'css-3d' || this.supportedAnimation === 'css-2d' ) {
				
			var previousSlide = that.previousSlideIndex;
				
			var prevslide_selector = $('.sp-slide'+previousSlide);
			
			this.options.orientation = that.settings.customcubeori;

			this.options.cuboidsCount = that.settings.customcubeCount;

			this.options.maxCuboidsCount = 5;

			this.options.sequentialFactor  = 150;

			this.options.speed = 700;

			this.options.easing = 'ease';
			
			this.options.perspective = '1200';

			this.size = new Object();

			this.size.width = target.width();

			this.size.height = target.height();

			this.$el = $('.sp-slides-container .sp-mask', target.parents());
			
			//this.$items = $('.sp-slide .sp-image-container');
			this.$items = $('.sp-slide', target.parents());
			...
			var boxStyle = {
				...
				config = $.extend( this.options, {
					...
					prev : this.previousSlideIndex,
					current : this.selectedSlideIndex,
					o : this.options.orientation
				} ),
				self = this;

			var box = $('<div>').addClass( 'sb-perspective' ).css( boxStyle ).appendTo( this.$el );
			...
			this.$items.eq( this.previousSliderIndex ).removeClass( 'sp-selected' ).hide();
			...
			for( var i = 0; i < this.options.cuboidsCount; ++i ) {
				...
				cuboid.rotate( function( pos ) {
					...
					if( pos === self.options.cuboidsCount - 1 ) {
						...
						box.remove();
						var $current = self.$items.eq( this.selectedSlideIndex );
						$current.css( 'display', 'block' ); // show() makes it inline style
						setTimeout(function() {
							$current.addClass( 'sp-selected' );
				...
				target.stop().animate({ 'opacity': opacity }, this.settings.customcubeDuration, function() {
					if ( typeof callback === 'function' ) {
						callback();
					}
				});
		...
		// Destroy the module
		destroyCustomCube: function() {
			this.off( 'update.' + NS );

			if ( this.customcubeGotoSlideReference !== null ) {
				this.gotoSlide = this.customcubeGotoSlideReference;
			}
		},

		customcubeDefaults: {

			// Indicates if customcube will be used
			customcube: false,

			// Indicates if the previous slide will be customcubed out (in addition to the next slide being customcubed in)
			customcubeOutPreviousSlide: true,

			// Sets the duration of the customcube effect
			customcubeDuration: 500,
	...
	$.SliderPro.addModule( 'CustomCube', CustomCube );

})( window, jQuery );


// CustomZoom module for Slider Pro.
// Adds the possibility to navigate through slides using a customzoom effect.
;(function( window, $ ) {

	"use strict";

	var NS = 'CustomZoom.' + $.SliderPro.namespace;

	var CustomZoom = {

		// Reference to the original 'gotoSlide' method
		customzoomGotoSlideReference: null,

		initCustomZoom: function() {
			this.on( 'update.' + NS, $.proxy( this._customzoomOnUpdate, this ) );
		},

		// If customzoom is enabled, store a reference to the original 'gotoSlide' method
		// and then assign a new function to 'gotoSlide'.
		_customzoomOnUpdate: function() {
			if ( this.settings.customzoom === true ) {
				this.customzoomGotoSlideReference = this.gotoSlide;
				this.gotoSlide = this._customzoomGotoSlide;
			}
		},

		// Will replace the original 'gotoSlide' function by adding a customzoom effect
		// between the previous and the next slide.
		_customzoomGotoSlide: function( index ) {
			if ( index === this.selectedSlideIndex ) {
				return;
			}
			if ( this.isAnimating )
				...
				this.isAnimating = false;
			// If the slides are being swiped/dragged, don't use customzoom, but call the original method instead.
			// If not, which means that a new slide was selected through a button, arrows or direct call, then
			// use customzoom.
			if ( this.$slider.hasClass( 'sp-swiping' ) ) {
				this.customzoomGotoSlideReference( index );
			} else {
				var that = this,
					$nextSlide,
					$previousSlide,
				...
				// Move the slides container so that the fading slides (which now have the top and left
				// position set to 0) become visible and in the center of the slider.
				this._moveTo( this.visibleOffset, true );

				// CustomZoom out the previous slide, if indicated, in addition to fading in the next slide
				if ( this.settings.customzoomOutPreviousSlide === true ) {
					this._customzoomSlideTo( $previousSlide, 0 );
				}

				// CustomZoom in the selected slide
				this._customzoomSlideTo( $nextSlide, 1, function() {
		...
		// CustomZoom the target slide to the specified opacity (0 or 1)
		_customzoomSlideTo: function( target, opacity, callback ) {
			var that = this;
			...
			if ( this.supportedAnimation === 'css-3d' || this.supportedAnimation === 'css-2d' ) {
				...
				var customcss = {
				        ...
				        //for firefox
				        "-moz-animation-name":"wprlszoomin",
				        "-moz-animation-duration":(duration/1000)+"s",
				        "-moz-animation-iteration-count":"1",
				            "-moz-animation-fill-mode":"forwards",

				        //for safari & chrome
				        "-webkit-animation-name":"wprlszoomin",
				        "-webkit-animation-duration":(duration/1000)+"s",
				        "-webkit-animation-iteration-count":"1",
				        "-webkit-animation-fill-mode" : "forwards",

				        //standard
				        "animation-name":"wprlszoomin",
				        "animation-duration":(duration/1000)+"s",
				        "animation-iteration-count":"1",
				        "animation-fill-mode" : "forwards",
				        'prespective': '1200px',
       				...
       				if (  this.settings.customzoomout ) {
       					customcss = {

					        //for firefox
					        "-moz-animation-name":"wprlszoomout",
					        "-moz-animation-duration":(duration/1000)+"s",
					        "-moz-animation-iteration-count":"1",
					            "-moz-animation-fill-mode":"forwards",

					        //for safari & chrome
					        "-webkit-animation-name":"wprlszoomout",
					        "-webkit-animation-duration":(duration/1000)+"s",
					        "-webkit-animation-iteration-count":"1",
					        "-webkit-animation-fill-mode" : "forwards",

					        //standard
					        "animation-name":"wprlszoomout",
					        "animation-duration":(duration/1000)+"s",
					        "animation-iteration-count":"1",
					        "animation-fill-mode" : "forwards",
					        'prespective': '1200px',
				...
				target.stop().animate({ 'opacity': opacity }, this.settings.customzoomDuration, function() {
					if ( typeof callback === 'function' ) {
						callback();
					}
					that.isAnimating = false;
		...
		// Destroy the module
		destroyCustomZoom: function() {
			this.off( 'update.' + NS );

			if ( this.customzoomGotoSlideReference !== null ) {
				this.gotoSlide = this.customzoomGotoSlideReference;
			}
		},

		customzoomDefaults: {

			// Indicates if customzoom will be used
			customzoom: false,

			customzoomout: false,

			// Indicates if the previous slide will be customzoomd out (in addition to the next slide being customzoomd in)
			customzoomOutPreviousSlide: true,

			// Sets the duration of the customzoom effect
			customzoomDuration: 500
		}
	};

	$.SliderPro.addModule( 'CustomZoom', CustomZoom );
	...
	var Video = {
		...
		_videoOnUpdate: function() {
			...
			this.$slider.find( 'a.sp-video' ).not( '[data-video-preinit]' ).each(function() {
				...
				that._preinitVideo( video, $( this ).parent().data('width'), $( this ).parent().data('height') );
			});
		},
		...
		_preinitVideo: function( video, width, height ) {
			var that = this;
			...
			video.on( 'click.' + NS, function( event ) {
				...
				$('.sp-layervideo').fitVids();


				if ( videoHeight !== 'auto' )
				$('.fluid-width-video-wrapper', video.parent()).css({'height': videoHeight});
...
//Load Google custom fonts for each layer
;(function( $ ){
...
$(document).ready(function() {
	...
	$('.sp-layertext').each(function() {

		var fontFamily = $('p',$(this)).css('font-family');
		...
		if ( $(this).data('font') !== '' ) {
			...
			var fontFamily = "'"+fontName.split('+').join(' ') + "'," +  fontFamily;
			
			$( 'p', $(this) ).css( 'font-family', fontFamily);
	...
	$.each( unique(fonts), function( index, value ) {

		var font = value;

		var link = apiUrl + font;
...
function wprls_deentitize_str( str ) {
    ...
    jQuery( document ).ready(function( $ ) {
        ...
        $('.wprlslayerslider').each(function() {
            ...
            var options = $.parseJSON($(this).attr('data-slider_options'));
            ...
            var height = options.height.replace(/[^\d.]/g, "");

            var width = options.width.replace(/[^\d.]/g, "");

            var nav_arrows = false;
            var nav_buttons = false;
            var fade = false;
            var custom_rotate = false;
            var custom_antirotate = false;
            var custom_cube = false;
            var customcubeori = 'h';
            var customcubeCount = 1;
            var custom_zoom = false;
            var custom_zoomout = false;
            var pause_vid_action = 'stopAutoplay';
            var full_width = false;
            var full_screen = false;
            var slide_bgcolor = false;
            var thumbnails_position = 'bottom';
            ...
            if ( options.nav_arrows === undefined )
            	nav_arrows = true;

            if ( options.slide_bgcolor !== undefined )
            	slide_bgcolor = options.slide_bgcolor;

            if ( options.thumbnails_position !== undefined )
            	thumbnails_position = options.thumbnails_position;
            
            if ( options.slide_animation == 'fade' )
            	fade = true;

            if ( options.slide_animation == 'slide' )
            	fade = false;

            if ( options.slide_animation == 'rotate' )
            	custom_rotate = true;

            if ( options.slide_animation == 'antirotate' )
            	custom_antirotate = true;


            if ( options.slide_animation == 'cube' )
            	custom_cube = true;

            if ( options.slide_animation == 'cubey' ) {
            	custom_cube = true;
            	customcubeori = 'v';
            }

            if ( options.slide_animation == 'cube3x' ) {
            	custom_cube = true;
            	customcubeori = 'h';
            	customcubeCount = 3;
            }

            if ( options.slide_animation == 'cube3y' ) {
            	custom_cube = true;
            	customcubeori = 'v';
            	customcubeCount = 3;
            }

            if ( options.slide_animation == 'cube5x' ) {
            	custom_cube = true;
            	customcubeori = 'h';
            	customcubeCount = 5;
            }

            if ( options.slide_animation == 'cube5y' ) {
            	custom_cube = true;
            	customcubeori = 'v';
            	customcubeCount = 5;
            }

            if ( options.slide_animation == 'zoom' )
            	custom_zoom = true;

            if ( options.slide_animation == 'zoomout' ) {
            	custom_zoom = true;
            	custom_zoomout = true;
            }
            ...
            custom_slice = false;
            custom_slice_effect = 'wave';

            if ( options.slide_animation == "slicewave" ) {
            	custom_slice = true;
            	custom_slice_effect = 'wave';
            }

            if ( options.slide_animation == "slice" ) {
            	custom_slice = true;
            	custom_slice_effect = 'slice';
            }

            if ( options.slide_animation == "puzzle" ) {
            	custom_slice = true;
            	custom_slice_effect = 'puzzle';
            }

            if ( options.slide_animation == "assemble" ) {
            	custom_slice = true;
            	custom_slice_effect = 'assemble';
            }

            if ( options.slide_animation == "ripple" ) {
            	custom_slice = true;
            	custom_slice_effect = 'ripple';
            }

            if ( ! options.pause_slideshow_vid )
            	pause_vid_action = 'none';
            ...
            thumbnails_arrow = options.thumbnails_arrow;
            ...
            $(selector).sliderPro({
                ...
                customrotate: custom_rotate,
                customantirotate: custom_antirotate,
                customcube: custom_cube,
                customcubeCount: customcubeCount,
                customcubeori: customcubeori,
                customzoom: custom_zoom,
                customzoomout: custom_zoomout,
                customslice: custom_slice,
                customsliceEffect: custom_slice_effect,
                reachVideoAction: options.autoplay_vid,
                playVideoAction: pause_vid_action,
                forceSize: full_width,
                fullScreen: full_screen,
                slideBgColor: slide_bgcolor,
                thumbnailsPosition: thumbnails_position,
                thumbnailArrows: thumbnails_arrow,
                touchSwipe: true,
                update: function() {
                ...
                init: function() {
		            ...
		            this.$slider.find('.sp-slides-container').addClass('wprls_slider_effect'+options.slider_shadow);

		            var style = "<style>.sp-previous-arrow:before, .sp-previous-arrow:after, .sp-next-arrow:before, .sp-next-arrow:after{ background-color: " + options.arrow_color +" } .sp-previous-thumbnail-arrow:before,.sp-previous-thumbnail-arrow:after,.sp-next-thumbnail-arrow:before,.sp-next-thumbnail-arrow:after{ background-color: " + options.arrow_color +" }.sp-selected-button { background-color: " + options.dots_color +" }.sp-selected-thumbnail { border: 4px solid;border-color:" + options.selected_thumb_border_color +"; }</style>";

		            $(style).appendTo(selector);

		           
		            if ( options.is_slider_border_color ) {

		            	this.$slider.find('.sp-mask').css({
		            		'border': '2px solid',
		            		'border-color': options.slider_border_color
		            	});
		            }

		            if ( options.dots_position == 'top' ) {

		            	this.$slider.find('.sp-buttons').css({
		            		'position': 'absolute',
		            		'top': 0,
		            		'z-index': 99999
		            	});
		            ...
		            if ( options.dots_position == 'left' ) {

		            	this.$slider.find('.sp-button').css({
		            		'display': 'block'
		            	});

		            	this.$slider.find('.sp-buttons').css({
		            		'width': options.dots_size+'px',
		            		'position': 'absolute',
		            		'top': '50%',
		            		'left': '2%',
		            ...
		            if ( options.dots_position == 'right' ) {
		            ...
		            this.$slider.find('.sp-button').css('border-color', options.dots_border_color);

		            this.$slider.find('.sp-button').css({
		            	'width': parseInt( options.dots_size )+'px',
		            	'height': parseInt( options.dots_size )+'px'
		            });
	            	
		            this.$slider.find('.sp-arrow').css({
		            	'transform': 'scale('+parseInt(options.arrow_size)+')'
		            });


	                if ( this.settings.slideBgColor ) {
	                   this.$slider.find('.sp-slide:not(.sp-image)').each( function( index ) {
	                   			
	                   			$(this).css('background-color', that.settings.slideBgColor );
	                   });
	                }
                   ...
                   layer = this.$slider.find('.sp-slide').first().find('.sp-layer');
					...
					resizeFunc = function() {
						...
						width = that.$slider.width();
						height = that.$slider.height();

						width = parseInt(that.$slider.data('iwidth'));
						height = parseInt(that.$slider.data('iheight'));

						that.$slider.find('.sp-layer').each(function (index) {

							position = new Object();
							
							position.top = parseInt($(this).css('top').replace('px',''));
							position.left = parseInt($(this).css('left').replace('px',''));

							newTop = position.top/height * 100;
							newLeft = position.left/width * 100;
							...
							$(this).data('newtop', newTop);
					    	$(this).data('newLeft', newLeft);
					...
					$(document).on('webkitfullscreenchange mozfullscreenchange fullscreenchange', function(e) {
					    ...
					    if ( event === 'On' ) {
					    	$('.sp-layertext').each(function(index) {
					    		oldwidth = parseInt($(this).data('oldwidth'));
					    	 	perc = width*(oldwidth/100);
					    	 	
					    	 	$(this).css({
					    	 		'width': perc+'px',
					    	 		'top': $(this).data('oldtop')+'px',
					    	 		'left': $(this).data('oldleft')+'px'
					    	 	});
					    ...
					    if ( event === 'Off' ) {
					    	$('.sp-layertext').each(function(index) {
					    		oldwidth = parseInt($(this).data('oldwidth'));
					    	 	$(this).css({
					    	 		'width': oldwidth+'%',
					    	 		'top': $(this).data('newtop')+'%',
					    	 		'left': $(this).data('newleft')+'%',
					    	 	});
					...
					if ( options.is_text_responsive ) {
						responsiveTextUnder = 700;

						if ( $(window).width() <= responsiveTextUnder  ) {

							$('.sp-layertext').each(function(index) {
								fontSize = parseInt($(this).css('font-size').replace('px',''));
								$(this).data('origfontsize',$(this).css('font-size'));
								$('p',$(this)).css({
						...
						$(window).wprlssmartresize(function() {
							...
							if ( $(window).width() <= responsiveTextUnder  ) {
								...
								$('.sp-layertext').each(function(index) {
									$('p',$(this)).css({
										'font-size': $(this).data('origfontsize')
									});
								});
